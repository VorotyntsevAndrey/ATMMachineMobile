...
public class UserAccountSpinnerAdapter extends ArrayAdapter<UserAccount> {

    public UserAccountSpinnerAdapter(@NonNull Context context, int resource, @NonNull List<UserAccount> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.tv_spinner_item))
                .setText(ATMSimpleDB.USER_ACCOUNT_LIST.get(position).getLogin());
